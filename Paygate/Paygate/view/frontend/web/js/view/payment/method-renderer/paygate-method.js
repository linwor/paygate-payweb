                                                ...
                                                jQuery.ajax({
                                                                ...
                                                                complete: function (data) {
                                                                    ...
                                                                    if (params.IFRAME != '0') {
                                                                        ...
                                                                        jQuery("body").append("<form name='paygate_checkout' id='paygate_checkout' action='https://secure.paygate.co.za/payweb3/process.trans' method='post'><input type='hidden' name='" + pkey[0] + "' value='" + pvalue[0] + "' size='200'><input type='hidden' name='" + pkey[1] + "' value='" + pvalue[1] + "' size='200'></form><script type='text/javascript'>document.getElementById('paygate_checkout').submit();</script>");
                                                                    }
                                                                }
                                                            });
                                            });
